...
class QS5BlockLineFormsScreen extends StatelessWidget {
  QS5BlockLineFormsScreen({
    Key? key,
                  ...
                  children: [
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Builder(
                          builder: (context) {
                            ...
                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: List.generate(qc12lmeasureditem.length,
                                  (qc12lmeasureditemIndex) {
                                final qc12lmeasureditemItem =
                                    qc12lmeasureditem[qc12lmeasureditemIndex];
                                return Container(
                                  width: sysWidth * 0.2,
                                  height: sysHeight * 0.1,
                                  decoration: BoxDecoration(
                    ...
                    FutureBuilder<ApiCallResponse>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Builder(
                          builder: (context) {
                            final qc12lsymbol = QcOneLimitDataCall.qc12lsymbol(
                    ...
                    FutureBuilder<ApiCallResponse>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Builder(
                          builder: (context) {
                            final qc12laccstd = QcOneLimitDataCall.qc12laccstd(
                    ...
                    FutureBuilder<ApiCallResponse>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Builder(
                          builder: (context) {
                            final qc12laccul = QcOneLimitDataCall.qc12laccul(
                    ...
                    FutureBuilder<ApiCallResponse>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Builder(
                          builder: (context) {
                            final qc12laccll = QcOneLimitDataCall.qcc12laccll(
                    ...
                    FutureBuilder<ApiCallResponse>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final actionstdQcOneLimitDataResponse = snapshot.data!;
                        return Builder(
                          builder: (context) {
                    ...
                    FutureBuilder<ApiCallResponse>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final actionulQcOneLimitDataResponse = snapshot.data!;
                        return Builder(
                          builder: (context) {
                            final qc12lactionul =
