...
import 'package:quality_system/screens/system_screens/head_line/qs_head_line_screens/qs_summary_screens/qs_4_healdine_summary/qs_4_2lH_summary_screen.dart';

class QS4HeadLine2LitreHybridFormsScreen extends StatelessWidget {
  QS4HeadLine2LitreHybridFormsScreen(
      {Key? key,
                    ...
                    onPressed: () async {
                      if (!controller.formKey.currentState!.validate()) {
                        ...
                        await Future.delayed(const Duration(milliseconds: 1500),
                            () {
                          Get.offAll(() => QS4HeadLine2LitreHybridSummaryScreen(
                                variant: variant,
                                shift: shift,
