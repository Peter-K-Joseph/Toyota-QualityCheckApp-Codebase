...
class QCCrankLineSummaryScreen extends StatelessWidget {
  QCCrankLineSummaryScreen({
    Key? key,
    this.measurername1,
    this.shift,
    this.processname,
                            ...
                            Flexible(
                              ...
                              child: FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final slnoQcOneLimitDataResponse =
                                      snapshot.data!;
                                  return Builder(
                                    builder: (context) {
                                  ...
                                  return Builder(
                                    builder: (context) {
                                      final qc12lmeasureditem =
                                        ...
                                        measureditemQcOneLimitDataResponse
                                            .jsonBody,
                                      ).toList();
                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
