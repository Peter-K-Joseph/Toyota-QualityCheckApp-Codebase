...
class HeadLineQS72HController extends GetxController {
  int? pm1;
  int? pm2;
  int? pm3;
  int? pm4;
  ...
  Future<void> getValues() async {
    ...
    try {
      ...
      final result = await httpServices.getRequest(
          endpoint: 'api/v1/qc7/headline?engine_type=2_0L_H');
  ...
  Future<void> postValues(
    ...
    String? endpont = "api/v1/qc7/headline/2.0L/Hybrid";
    ...
    try {
      ...
      final result = await httpServices.postRequest(endpoint: endpont, data: {
        ...
        "INT face, Water outlet Tube union press fitting surface. ": pm3,
        "INT face, Water outlet Tube union press fit height": pm4,
        ...
        "Sealant application surface Int Tube union press fit hole": pm10
      });
