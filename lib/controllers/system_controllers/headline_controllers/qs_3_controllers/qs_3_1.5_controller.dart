...
class HeadLineQS31Point5Controller extends GetxController {
  int? pm1;
  int? pm2;
  int? pm3;
  int? pm4;
  ...
  Future<void> getValues() async {
    ...
    try {
      ...
      final result = await httpServices.getRequest(
          endpoint: 'api/v1/qc3/headline?engine_type=1_5L');
  ...
  Future<void> postValues(
    ...
    String? endpont = "api/v1/qc3/headline/1.5L";
    ...
    try {
      ...
      final result = await httpServices.postRequest(endpoint: endpont, data: {
        ...
        "Bottom face, oil drop hole guide hole drilling": {
          "42PS": pm62,
          "155PS": pm61
        },
        ...
        "FR face, main oil hole depth penetration check (b)": pm129,
        "Rear face,main oil hole depth penetration check (a) (b)": pm130,
        ...
        "Front face chain cover mounting screw pilot hole  diameter": pm141,
        "Front face chain cover mounting screw pilot hole  depth": pm142,
        "Front face chain cover mounting screw hole diamter": pm143,
        "Front face chain cover mounting screw hole depth": pm144,
        "Front face chain mounting screw hole depth": pm145,
        "Front face chain mounting screw hole diameter": pm146,
        ...
        "Top face, cam housing assy knock hole pitch": pm161,
        "Bottom face, Machining knock hole pitch": pm163,
        "Bottom face, Block assy knock hole pitch": pm164
      });
